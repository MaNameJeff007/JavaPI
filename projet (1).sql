...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 16 avr. 2020 à 10:01
...
INSERT INTO `absences` (`id`, `enseignant_id`, `eleve_id`, `dateabs`, `justification`, `heuredebut`, `heurefin`, `etat`) VALUES
(9, 6, 7, '2019-03-09', 'maladie', 12, 13, 1),
(10, 6, 7, '2019-04-03', 'maladie', 14, 15, 0),
(11, 6, 9, '2020-03-04', 'a ajouter', 8, 16, 0);
...
INSERT INTO `classe` (`id`, `niveau`, `libelle`, `capacite`) VALUES
(1, 3, 'classe', 20),
(2, 1, '1A2', 52),
(3, 1, '1A3', 30),
(4, 2, '2A6', 30),
...
(58, 1, 'isims', '20180710_231024.jpg'),
(59, 7, 'rootSPACE', '20180710_231024.jpg'),
(64, 7, 'wiwhi<', 'Photo ID MohamedTurki.png'),
(65, 1, 'mohsen', 'Photo ID MohamedTurki.png');
...
(1, 11, 1, 'La gestion d\'une classe en élémentaire : la discipline, les emplois du temps, les affichages, le matériel scolaire', '2020-04-27 00:00:00', 2),
(2, 11, 2, 'a correction des cahiers, les classes à plusieurs niveaux, différencier sa pédagogie', '2020-04-29 00:00:00', 4);
...
(1, 58, '', 'new event1', NULL, '2020-04-01 00:00:00', '2020-04-09 00:00:00');
...
INSERT INTO `exercice` (`id`, `course_id`, `question`, `reponse`, `score`) VALUES
(1, 4, 'pk?', 'pnn', '3'),
(2, 4, 'pourquoi la terre est ronde?', 'gravité', '1'),
(3, 4, 'pourquoi la mer est bleu?', 'reflection', '0'),
(4, 4, 'pourquoi la vie?', '42', '3'),
(5, 4, 'Ou est ce que se trouve Bizerte?', 'Nord', '1'),
(6, 3, 'Ou est ce que se trouve Nabeul?', 'nord est', '3'),
(7, 3, 'Ou est ce que se trouve Gabes?', 'sud', '1'),
(8, 3, 'Ou est ce que se trouve Sidi Bouzid?', 'ouest', '1'),
(9, 8, 'quel le capital du maroc?', 'casablanca', '1'),
(10, 8, 'quel le capital de la France?', 'Paris', '1'),
(11, 8, 'quel le capital de l\'italie?', 'Rome', '1'),
(12, 8, 'quel le capital de l\'allemagne ?', 'Berlin', '1'),
(13, 9, 'quel est le resultat de 4/2?', '2', '1'),
(14, 9, 'quel est le resultat de 10*4?', '40', '1'),
(15, 3, 'quel est le resultat de 14*4?', '56', '1'),
(16, 9, 'quel est le resultat de 14*4?', '56', '1'),
(17, 9, 'quel est le resultat de 14*4?', '56', '1'),
(18, 9, 'quel est le resultat de 35*1?', '35', '1'),
(19, 10, 'Le verbe etre avec tu:', 'es', '2'),
(20, 10, 'Le verbe etre avec il:', 'est', '1'),
(21, 10, 'Le verbe etre avec nous:', 'sommes', '1'),
(22, 10, 'Le verbe etre avec vous:', 'etes', '1'),
(23, 10, 'quel est le capital de la Tunisie?', 'Tunis', '1');
...
(1, '3A5', 'fdsfsdf', 'non traitee', '2020-02-27 08:58:45', 8, 6, '');
...
(1, 6, 3, '2020-02-27 08:55:17', 'traitee', ''),
...
(23, 2, 0, '2020-02-19 23:16:43'),
(24, 2, 7, '2020-02-19 23:28:54'),
...
INSERT INTO `signaler` (`id`, `sujet`, `commentaire`, `nombre`, `type`) VALUES
(7, 13, NULL, 1, 'sujet');
...
(11, 3, 'Les domaines d\'activité à l\'école élémentaire', 'Organiser, préparer et gérer une classe en élémentaire L\'élémentaire au jour le jour Thèmes et projets pour l\'élémentaire Français Mathématiques Histoire et géographie', '2020-04-21 00:00:00', 54, 120),
(12, 2, 'Documents pédagogiques gratuits et bons plans', 'Liens vers des sites proposant des ressources pédagogiques gratuites.', '2020-04-21 00:00:00', 22, 199),
(13, 1, 'Enseigner à l\'étranger', 'Enseigner à l\'étranger : discussions, ressources et informations.', '2020-04-26 00:00:00', 7, 33),
(15, 21, 'test', 'test', '2020-04-16 10:21:35', 0, 0);
...
INSERT INTO `user` (`id`, `parent_id`, `classeeleve_id`, `classeenseignant_id`, `username`, `username_canonical`, `email`, `email_canonical`, `enabled`, `salt`, `password`, `last_login`, `confirmation_token`, `password_requested_at`, `roles`, `nom`, `prenom`, `date_embauche`, `date_inscription`) VALUES
(1, NULL, NULL, NULL, 'mohamed', 'borchani', 'mohamedturki@gmail.com', 'mohamedturki@gmail.com', 1, NULL, '$2y$13$mYQn1Amj9zb3sbmZ2Ug67eUelIU1rCtrem451ZerAZzNAYOa6Rpru', '2020-02-27 03:42:54', NULL, NULL, 'a:1:{i:0;s:15:\"ROLE_ENSEIGNANT\";}', 'mohamed', 'borchani', '2020-02-26', '2020-02-26'),
(2, NULL, NULL, NULL, 'ahmed', 'ahmed', 'ahmed1234@gmail.com', 'ahmed1234@gmail.com', 1, NULL, '$2y$13$Bf63EBhITB2uXVb9uQtj/uowK987YTmfEUqSoqUpi43HUfHr/idWC', '2020-02-27 03:43:09', NULL, NULL, 'a:1:{i:0;s:10:\"ROLE_ADMIN\";}', 'ahmed', 'turki', '2020-02-26', '2020-02-26'),
(3, NULL, NULL, NULL, 'eleve', 'eleve', 'eleve.eleve@eleve.eleve', 'eleve.eleve@eleve.eleve', 1, NULL, '$2y$13$ARpR5ntLxSKzsP1WTmwjH.mDx7QRJ2ngGR9mpto38QCw.wyCcQtla', '2020-02-26 19:01:21', NULL, NULL, 'a:1:{i:0;s:10:\"ROLE_ELEVE\";}', 'eleve', 'eleve', '2020-02-26', '2020-02-26'),
(4, NULL, NULL, NULL, 'cc', 'cc', 'cc@cc.com', 'cc@cc.com', 1, NULL, '$2y$13$DS6WpNdYKUiXrqIw3aAe1uEbRQpu/U7SSFNhW7FDpMTCCfdvuj1Om', '2020-04-09 22:37:34', NULL, NULL, 'a:1:{i:0;s:10:\"ROLE_ELEVE\";}', 'cc', 'cc', '2020-02-26', '2020-02-26'),
(5, NULL, NULL, NULL, 'aa', 'aa', 'aa@aa.com', 'aa@aa.com', 1, NULL, '$2y$13$DS6WpNdYKUiXrqIw3aAe1uEbRQpu/U7SSFNhW7FDpMTCCfdvuj1Om', '2020-03-05 16:37:06', NULL, NULL, 'a:1:{i:0;s:10:\"ROLE_ELEVE\";}', 'aaa', 'aabb', '2020-02-26', '2020-02-26'),
(6, NULL, NULL, NULL, 'bb', 'bb', 'bb@bb.com', 'bb@bb.com', 1, NULL, '$2y$13$DS6WpNdYKUiXrqIw3aAe1uEbRQpu/U7SSFNhW7FDpMTCCfdvuj1Om', '2020-04-09 22:55:46', NULL, NULL, 'a:1:{i:0;s:11:\"ROLE_ADMIN\";}', 'bb', 'bb', '2020-02-26', '2020-02-26'),
(7, NULL, NULL, 1, 'mohamedhh', 'mohamedhh', 'mohamed12345@gmail.com', 'mohamed12345@gmail.com', 1, NULL, '$2y$13$LnHFK6Lbzm3.nebQslOqAOhrr3osQd6Z1tUX7A2EICDZLFUFEZR9G', '2020-02-27 08:26:41', NULL, NULL, 'a:1:{i:0;s:15:\"ROLE_ENSEIGNANT\";}', 'mohamed', 'turki', '2020-02-27', '2020-02-27'),
(8, 6, 1, NULL, 'testttt', 'testttt', 'test20@gmail.com', 'test20@gmail.com', 1, NULL, '$2y$13$Ex4thmI8NjeHUnVPcrq0w.MDPmUqpeVTyQcH2GRn8mol4Z2L4hD8y', '2020-02-27 08:09:30', NULL, NULL, 'a:1:{i:0;s:10:\"ROLE_ADMIN\";}', 'test20', 'test20', '2020-02-27', '2020-02-27'),
(9, NULL, NULL, NULL, 'dd', 'dd', 'dd@dd.com', 'dd@dd.com', 1, NULL, '$2y$13$mZITwSjSBa5ES/A9rK7evO5xlYh0cQJnEphn7ZFedxKRzGnAZTsaq', '2020-02-27 08:43:47', NULL, NULL, 'a:1:{i:0;s:11:\"ROLE_PARENT\";}', 'dd', 'dd', '2020-02-27', '2020-02-27');
